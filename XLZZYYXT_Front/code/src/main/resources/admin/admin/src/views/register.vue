  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
        <h1 class="h1" style="color:#000;fontSize:28px;">心理咨询预约系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱" type="text" />
																								...
																								<!-- <div v-if="tableName=='xinlizixunshi'" class="input-group">
			   <div class="label">咨询师账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zixunshizhanghao" class="input" type="text" placeholder="咨询师账号">
			   </div>
			 </div> -->
			<el-form-item label="咨询师账号" class="input" v-if="tableName=='xinlizixunshi'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='xinlizixunshi'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='xinlizixunshi'" class="input-group">
			...
			<el-form-item label="咨询师姓名" class="input" v-if="tableName=='xinlizixunshi'">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='xinlizixunshi'">
			...
			<el-form-item label="地址" class="input" v-if="tableName=='xinlizixunshi'">
			...
			<el-form-item label="手机号" class="input" v-if="tableName=='xinlizixunshi'">
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                                                                              ...
                                                                                                                              if(`xinlizixunshi` == this.tableName && this.ruleForm.nianling&&(!this.$validate.isIntNumer(this.ruleForm.nianling))){
        this.$message.error(`年龄应输入整数`);
        return
      }
                                                                                                                                                                                                if(`xinlizixunshi` == this.tableName && this.ruleForm.shoujihao&&(!this.$validate.isMobile(this.ruleForm.shoujihao))){
